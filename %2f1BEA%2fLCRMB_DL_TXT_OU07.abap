FUNCTION /1BEA/CRMB_DL_TXT_O_READ.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
* EXPLAIN:
* Use generic functions to read texts for a DL item

* READ does not return texts to the caller. It is only a preparatory
* step for text display via standard subscreens of text processing.
